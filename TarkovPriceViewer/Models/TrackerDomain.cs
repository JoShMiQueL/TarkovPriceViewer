...
namespace TarkovPriceViewer.Models
{
    ...
    public class TrackerUpdateResult
    {
        ...
        public static TrackerUpdateResult Ok(CurrentTrackedObjective objective)
        {
        ...
        public static TrackerUpdateResult Fail(TrackerUpdateFailureReason reason, CurrentTrackedObjective objective = null)
        {
            return new TrackerUpdateResult
            {
                Success = false,
